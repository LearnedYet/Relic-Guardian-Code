...
- **Implemented and runtime-verified for Attack1 -> Attack2 -> Free**
...
- This document records both verified implementation and intended architecture. Restart Window, Attack3/4 extension, and explicit stale-event identity protection remain unimplemented.
